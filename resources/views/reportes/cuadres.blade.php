    ...
    <div class="row">
        ...
        <div class="col-12  col-lg-6 col-xl-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center px-4" style="height: 7em;">
                    ...
                    <div class="col">
                        <div class="col-12 text-end">
                            <h3><b>${{ number_format($efectivo) }}</b></h3>
                        </div>
                        <div class="col-12 text-end">
                            <small><b>Efectivo del dia</b></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12  col-lg-6 col-xl-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center px-4" style="height: 7em;">
                    <div class="col">
                        <i class="fa-solid fa-money-bill-transfer fa-3x text-warning"></i>
                    </div>
                    <div class="col">
                        <div class="col-12 text-end">
                            <h3><b>${{ number_format($transaccion) }}</b></h3>
                        </div>
                        <div class="col-12 text-end">
                            <small><b>Transacciónes del dia</b></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-xl-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body d-flex align-items-center justify-content-center px-4" style="height: 7em;">
                    <div class="col">
                        <i class="fa-solid fa-solid fa-file-invoice-dollar fa-3x text-primary"></i>
                    </div>
                    <div class="col">
                        <div class="col-12 text-end">
