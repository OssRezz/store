...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card">
                <div class="card-header"><i class="fa-solid fa-edit"></i> <b>Actualizar salida</b>
                </div>
                <div class="card-body">

                    <form method="POST" action="{{ url('admin/salidas/update', $salida->id) }}">
                        @csrf
                        @method('PUT')
                        <input type="text" class="form-control" placeholder="Valor" name="id_producto"
                            value="{{ $salida->producto_id }}" hidden />
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" placeholder="Valor" name="nombre_producto"
                                value="{{ $salida->productoFk->nombre }}" readonly />
                            <label>Producto </label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" placeholder="Valor" name="codigo_producto"
                                id="codigo" readonly value="{{ $salida->productoFk->codigo }}" />
                            <label>Codigo </label>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <textarea name="observaciones" class="form-control" placeholder="observaciones">{{ $salida->observaciones }}</textarea>
