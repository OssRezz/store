...
@section('content')
        ...
        <div class="col-12 col-lg-7">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <small><span class="badge bg-dark">Factura: <b id="factura"
                                class="{{ $factura }}">{{ $factura }}</b></span></small>
                </div>
                <div class="card-body">
            ...
            <div class="card mb-4">
                <div class="card-body pb-0">
                    <input type="text" value="{{ json_encode($detalle_compras) }}" id="contenidoCompra" hidden>
    ...
    <script src="{{ asset('assets/js/compras/detalleCompras.js') }}" defer></script>
