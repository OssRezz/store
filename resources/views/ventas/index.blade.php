...
@section('content')
        ...
        <div class="col-12 col-lg-7">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12 mb-3" id="colSegundaForma">
                        <div class="form-floating">
                    ...
                    <div class="col-12 mb-3" id="colValorSegunda">
                        <div class="form-floating">
                    ...
                    <div class="d-grid">
                        <button class="btn btn-outline-danger" onclick="guardarCompra(this)">Guardar venta</button>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('assets/js/ventas/producto.js') }}" defer></script>
@endsection
